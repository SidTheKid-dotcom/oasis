    ...
    <div className="bg-black p-8 w-full max-w-md mx-auto rounded-2xl text-white">
      ...
      {mode === "Sign In" && (
        <div>
          ...
          <div className="mt-6 text-center">
            <button
              className="w-full py-2 rounded bg-pink-500 hover:bg-pink-600 transition duration-300"
              onClick={signIn}
            >
      ...
      {mode === "Sign Up" && (
        <div className="space-y-4 mt-6">
          ...
          <div className="space-y-2">
            <label htmlFor="signup-email" className="block text-white">
              Email
            </label>
            <input
              id="signup-email"
          ...
          <div className="space-y-2">
            <label htmlFor="signup-password" className="block text-white">
              Password
            </label>
            <input
              id="signup-password"
